...
async function scanAndProcess(rootDir: string, generator: ReportGenerator, formats: string[]): Promise<void> {
...
async function processProject(projectPath: string, generator: ReportGenerator, formats: string[]): Promise<void> {
